...
import com.example.p02instgram.main.CommonDivider
import com.example.p02instgram.main.CommonImage
...
fun ProfileScreen(navController: NavController, vm: IgViewModel) {
    ...
    if(isLoading) {
        ...
        //上方要引用 androidx.compose.runtime.getValue 和 androidx.compose.runtime.setValue
